...
<figure class="cube"><img src="<?php bloginfo('template_directory'); ?>/images/h1logo.png" alt="パチンコ･スロット夢らんど" width="140" height="140" class="front" /><img src="<?php bloginfo('template_directory'); ?>/images/h1logo.png" width="140" height="140" class="back" alt="パチンコ･スロット夢らんど" /></figure>
</a></h1>
<div class="hright">
<div class="hright_top clearfix">
<h2><img src="<?php bloginfo('template_directory'); ?>/images/h2logo.png" alt="夢らんど" width="100%" /></h2>
<div class="catch"><img src="<?php bloginfo('template_directory'); ?>/images/catch.jpg" alt="一人でも多くの人に「喜び」「幸せ」が提供できること、それが私たちの願いです。" width="328" height="28" /></div>
<div class="sub_wrap">
...
<div class="point3_imgz"><img src="<?php bloginfo('template_directory'); ?>/images/point3_02_01.jpg" alt="夢らんどグループ採用情報" width="312" height="95" /></div>
<div id="youtubep01">
...
<div class="point3_img2"><a href="<?php echo home_url() ; ?>/tenpo/"><span></span><img src="<?php bloginfo('template_directory'); ?>/images/point3_1.jpg" alt="夢らんど各店舗情報" width="300" height="41" /></a> </div>
</li>
<li>
<div class="point3_img"><img src="<?php bloginfo('template_directory'); ?>/images/point3_01_01.jpg" alt="夢らんどグループ採用情報" width="312" height="95" /></div>
	
<div class="point3_img2"><a href="<?php echo home_url() ; ?>/saiyou/"><span></span><img src="<?php bloginfo('template_directory'); ?>/images/point3_2.jpg" alt="採用情報" width="300" height="41" /></a> </div>
</li>
<li>
<div class="point3_img"><img src="<?php bloginfo('template_directory'); ?>/images/point3_03_01.jpg" alt="夢らんどグループ企業情報" width="312" height="95" /></div>
<div class="point3_img2"><a href="<?php echo home_url() ; ?>/company/"><span></span><img src="<?php bloginfo('template_directory'); ?>/images/point3_3.jpg" alt="企業情報" width="300" height="41" /></a> </div>
</li>
</ul>
</div>
<!--point3 END-->
...
<div class="top_facebook"><a href="https://www.facebook.com/taiheiyumeland" target="_blank"><span class="button_facebook"><img src="<?php bloginfo('template_directory'); ?>/images/top_arrow.png" alt="夢らんどFacebookへ" width="33" height="33" /></span>
...
<ul class="glance">
<li><a href="http://taihei-g.co.jp/" target="_blank" class="glance"><img src="<?php bloginfo('template_directory'); ?>/images/flink01.gif" width="150" height="28" alt="埼玉県杉戸町の太平グループ 総合事業商社" /></a> </li>
<li><a href="http://www.hotel-landl.com/" target="_blank" class="glance"><img src="<?php bloginfo('template_directory'); ?>/images/flink02.gif" alt="ラブホテルエルアンドエル大宮店・草加店" width="150" height="28" /></a> </li>
<li><a href="http://www.taihei-g.co.jp/golf/" target="_blank" class="glance"><img src="<?php bloginfo('template_directory'); ?>/images/flink03.gif" alt="野田太平ゴルフセンター" width="150" height="28" /></a> </li>
<li><a href="http://www.taiheikotsu.co.jp/" target="_blank" class="glance"><img src="<?php bloginfo('template_directory'); ?>/images/flink04.gif" alt="杉戸町・宮代町のタクシー送迎太平交通株式会社" width="150" height="28" /></a> </li>
<li><a href="http://www.taiheihome.co.jp/" target="_blank" class="glance"><img src="<?php bloginfo('template_directory'); ?>/images/flink05.gif" alt="いつかは夢の家づくり太平ホーム株式会社" width="150" height="28" /></a> </li>
<li><a href="http://www.taiheibiru.co.jp/" target="_blank" class="glance"><img src="<?php bloginfo('template_directory'); ?>/images/flink06.gif" alt="太平ビル管理株式会社" width="150" height="28" /></a> </li>
</ul>
</div>
</div>
<div id="footer2">
